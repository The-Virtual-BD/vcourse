                ...
                <div class="row event-sub-section-main">
                    <div class="col-lg-8">
                        ...
                        <div class=" d-flex justify-content-between">
                            <div class="d-none w-100" id="courseNameForm">
                                <div class="d-flex  w-100">
                                    <form id="" method="post" action="{{ route('courses.update', $course->id) }}" class="d-flex w-80 flex-fill">
                                        @method('patch')
                                        @csrf
                                        <input type="text" name="name" id="" class="form-control" value="{{$course->name}}"/>
                                        <input type="submit" value="Set" class="btn btn-primary px-5 mx-1">
                                    </form>
                                    <button id="courseNameFormCancel" class="btn btn-secondary mx-1">x</button>
                                </div>
                            </div>
                            <h3 class="font-title--sm" id="courseName">
                                {{$course->name}}
                            </h3>
                            <i id="courseNamepen" class="ti-pencil"></i>

                        </div>
                        <div class="created-by d-flex align-items-center">
                            <div class="created-by-image me-3">
                                <img src="{{asset($course->user->profile_picture)}}" alt="Instructor">
                            </div>
                            <div class="created-by-text">
                                <p>Created by</p>
                                <h6><a href="@auth @if ($course->user->id == Auth::user()->id)
                                    {{route('profile.myprofile', Auth::user()->id)}}
                                @else
                                    {{route('profile.instructor', $course->user->id)}}
                                @endif
                                @endauth
                                @guest{{route('profile.instructor', $course->user->id)}}@endguest">{{$course->user->name}}</a></h6>
                                <div class="d-none w-100" id="courseInsForm">
                                    <div class="d-flex  w-100">
                                        <form id="" method="post" action="{{ route('courses.update', $course->id) }}" class="d-flex w-80 flex-fill">
                                            @method('patch')
                                            @csrf
                                            ...
                                            <select name="user_id" id="" class="form-control">
                                                @foreach ($instructors as $instructor)
                                                    <option value="{{$instructor->id}}" @if($instructor->id == $course->user_id)Selected @endif>{{$instructor->name}}</option>
                                                @endforeach
                                            </select>
                                            <input type="submit" value="Set" class="btn btn-primary px-5 mx-1">
                                        </form>
                                        <button id="courseInsFormCancel" class="btn btn-secondary mx-1">x</button>
                                    </div>
                                </div>
                            </div>
                            <i id="courseInspen" class="ti-pencil"></i>
                        ...
                        <div class="icon-with-date d-flex align-items-lg-center">
                            <div class="icon-with-date-start d-flex align-items-center">
                                <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.94438 2.34287L11.7457 5.96656C11.8359 6.14934 12.0102 6.2769 12.2124 6.30645L16.2452 6.88901C16.4085 6.91079 16.5555 6.99635 16.6559 7.12701C16.8441 7.37201 16.8153 7.71891 16.5898 7.92969L13.6668 10.7561C13.5183 10.8961 13.4522 11.1015 13.4911 11.3014L14.1911 15.2898C14.2401 15.6204 14.0145 15.93 13.684 15.9836C13.5471 16.0046 13.4071 15.9829 13.2826 15.9214L9.69082 14.0384C9.51037 13.9404 9.29415 13.9404 9.1137 14.0384L5.49546 15.9315C5.1929 16.0855 4.82267 15.9712 4.65778 15.6748C4.59478 15.5551 4.57301 15.419 4.59478 15.286L5.29479 11.2975C5.32979 11.0984 5.26368 10.8938 5.11901 10.753L2.18055 7.92735C1.94099 7.68935 1.93943 7.30201 2.17821 7.06246C2.17899 7.06168 2.17977 7.06012 2.18055 7.05935C2.27932 6.9699 2.40066 6.91001 2.5321 6.88668L6.56569 6.30412C6.76713 6.27223 6.94058 6.14623 7.03236 5.96345L8.83215 2.34287C8.90448 2.19587 9.03281 2.08309 9.18837 2.03176C9.3447 1.97965 9.51582 1.99209 9.66282 2.06598C9.78337 2.12587 9.88215 2.22309 9.94438 2.34287Z" stroke="#FF7A1A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <p class="font-para--md">{{$course->rating_quantity/$course->rating_number}} Star <span>({{$course->rating_number}})</span></p>
                            </div>
                            <div class="icon-with-date-end d-flex align-items-center">
                                <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 16.5C13.1421 16.5 16.5 13.1421 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5Z" stroke="#FFC91B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M9 4.5V9L12 10.5" stroke="#FFC91B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <p class="font-para--md">{{$course->time_duration}} Hours</p>
                            </div>
                        </div>
                        <div class="icon-with-date d-flex align-items-lg-cente mb-0">
                            <div class="icon-with-date-start d-flex align-items-center">
                                <svg width="19" height="18" viewbox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 9C1 9 4 3 9.25 3C14.5 3 17.5 9 17.5 9C17.5 9 14.5 15 9.25 15C4 15 1 9 1 9Z" stroke="#1089FF" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M9.25 11.25C10.4926 11.25 11.5 10.2426 11.5 9C11.5 7.75736 10.4926 6.75 9.25 6.75C8.00736 6.75 7 7.75736 7 9C7 10.2426 8.00736 11.25 9.25 11.25Z" stroke="#1089FF" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <p class="font-para--md">{{$course->student_enrolled}} Enrolled</p>
                            </div>
                            <div class="icon-with-date-end d-flex align-items-center">
                                <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.5 2.25H6C6.79565 2.25 7.55871 2.56607 8.12132 3.12868C8.68393 3.69129 9 4.45435 9 5.25V15.75C9 15.1533 8.76295 14.581 8.34099 14.159C7.91903 13.7371 7.34674 13.5 6.75 13.5H1.5V2.25Z" stroke="#00AF91" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M16.5 2.25H12C11.2044 2.25 10.4413 2.56607 9.87868 3.12868C9.31607 3.69129 9 4.45435 9 5.25V15.75C9 15.1533 9.23705 14.581 9.65901 14.159C10.081 13.7371 10.6533 13.5 11.25 13.5H16.5V2.25Z" stroke="#00AF91" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <p class="font-para--md">{{$course->number_of_lessons}} Lesson</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="course-overview">
                            <div class="course-overview-image">
                                {{-- thumbnail image --}}
                                <div class="d-none w-100" id="courseThumbForm">
                                    <div class="d-flex  w-100">
                                        <form id="" method="post" action="{{ route('courses.update', $course->id) }}" class="d-flex w-80 flex-fill" enctype="multipart/form-data">
                                            @method('patch')
                                            @csrf
                                            <input type="file" name="thumbnail" id="" class="form-control">
                                            <input type="submit" value="Set" class="btn btn-primary px-5 mx-1">
                                        </form>
                                        <button id="courseThumbFormCancel" class="btn btn-secondary mx-1">x</button>
                                    </div>
                                </div>
                                <span><i id="courseThumbpen" class="ti-pencil"></i></span>
                                <img src="{{asset($course->thumbnail)}}" alt="img">
                                <a class="popup-video play-button" href="{{$course->media_link}}" target="_blank">
                            ...
                            <ul class="nav course-overview-nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active font-para--lg px-3" id="pills-courseoverview-tab" data-bs-toggle="pill" data-bs-target="#pills-courseoverview" type="button" role="tab" aria-controls="pills-courseoverview" aria-selected="true">
                                        Overview
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link font-para--lg px-3" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                                        Curriculum
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link font-para--lg px-3" id="pills-c-instructor-tab" data-bs-toggle="pill" data-bs-target="#pills-c-instructor" type="button" role="tab" aria-controls="pills-c-instructor" aria-selected="false">
                                        Instructor
                                    </button>
                                </li>
                                <li class="nav-item d-none" role="presentation">
                                    <button class="nav-link me-0 font-para--lg px-3" id="pills-course-review-tab" data-bs-toggle="pill" data-bs-target="#pills-review" type="button" role="tab" aria-controls="pills-course-review-tab" aria-selected="false">
                                        Review
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content course-overview-content" id="pills-tabContentTwo">
                                <div class="tab-pane fade show active" id="pills-courseoverview" role="tabpanel" aria-labelledby="pills-courseoverview-tab">
                                    ...
                                    <form id="" method="post" action="{{ route('courses.update', $course->id) }}" class="" enctype="multipart/form-data">
                                        @method('patch')
                                        @csrf
                                        ...
                                        <div class="row course-overview-main mt-4">
                                            <div class="course-overview-main-item">
                                                ...
                                                <textarea name="description" id="description" cols="30" rows="4" class="form-control">{!!$course->description!!}</textarea>
                                            </div>
                                            <div class="course-overview-main-item">
                                                <h6 class="font-title--card">Requirments</h6>
                                                <textarea name="requirments" id="requirments" cols="30" rows="4" class="form-control">{!!$course->requirments!!}</textarea>
                                            </div>
                                            <div class="course-overview-main-item">
                                                <h6 class="font-title--card">Who This Course is For</h6>
                                                <textarea name="forwho" id="forwho" cols="30" rows="4" class="form-control">{!!$course->forwho!!}</textarea>
                                            </div>
                                            <div class="course-overview-main-item mb-0">
                                                <h6 class="font-title--card">What You Will be Learn</h6>
                                                <textarea name="what_will_learn" id="what_will_learn" cols="30" rows="4" class="form-control">{!!$course->what_will_learn!!}</textarea>
                                            </div>
                                        </div>
                                        <input type="submit" value="Save" class="btn btn-primary px-5 mx-1 mt-3">
                                    </form>
                                            ...
                                            <div class="curriculum-area">
                                                <div class="curriculum-area-top">
                                                    <div class="total-lesson">
                                                        ...
                                                        <p>{{$course->lessons->count()}} Lesson</p>
                                                    </div>
                                                    <div class="total-hours">
                                                        <svg width="18" height="19" viewbox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M9 17C13.1421 17 16.5 13.6421 16.5 9.5C16.5 5.35786 13.1421 2 9 2C4.85786 2 1.5 5.35786 1.5 9.5C1.5 13.6421 4.85786 17 9 17Z" stroke="#FFC91B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            <path d="M9 5V9.5L12 11" stroke="#FFC91B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        </svg>
                                                ...
                                                <div class="course-instructor-info">
                                                    ...
                                                    <div class="instructor-text">
                                                        ...
                                                        <p class="font-para--md">
                                                            @if ($course->user->designation == null)
                                                            Instructor
                                                            @else
                                                            {{$course->user->designation}}
                                                            @endif
                                                        </p>
                                                        <div class="d-flex align-items-center instructor-text-bottom d-none">
                                        ...
                                        <div class="tab-pane fade" id="pills-courses" role="tabpanel" aria-labelledby="pills-courses">
                                            <div class="row">
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/demo-img-01.png')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                                    <a href="#">Chicago International Conference on Education</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course__content_author">
                                                                <div class="info">
                                                                    <a href="#" class="info_img"><img src="{{asset('images/frontimages/courses/7.png')}}" alt="client-image"></a>
                                                            ...
                                                            <div class="course__content_time d-flex justify-content-between align-items-center">
                                                                <div class="star d-flex align-items-center">
                                                                    <div class="icon pe-2">
                                                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M9 1.5L11.3175 6.195L16.5 6.9525L12.75 10.605L13.635 15.765L9 13.3275L4.365 15.765L5.25 10.605L1.5 6.9525L6.6825 6.195L9 1.5Z" stroke="#FF7A1A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                        </svg>
                                                                    </div>
                                                                    <span>4.5</span>
                                                                </div>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/demo-img-02.png')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/demo-img-05.png')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                                    <a href="#">Let's Color a Goblin with Procreate! Complete Color...</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course__content_author">
                                                                <div class="info">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/demo-img-03.png')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                                    <a href="#">2020 Complete Drawing Masterclass. From Beginner to...</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course__content_author">
                                                                <div class="info">
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/8.jpg')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    <div class="course">
                                                        <div class="course__img">
                                                            <a href="#"><img src="{{asset('images/frontimages/courses/demo-img-04.png')}}" alt="images" class="img-fluid"></a>
                                                        </div>
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                                    <a href="#">Graphic Design Masterclass - Learn Great Design...</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course__content_author">
                                                                <div class="info">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="course">
                                                        ...
                                                        <div class="course__content">
                                                            <div class="course__content_title">
                                                                <h6>
                                                                    <a href="#">Gamification: Motivation Psychology &amp; The Art of...</a>
                                                                </h6>
                                                            </div>
                                                            <div class="course__content_author">
                                                                <div class="info">
                                                        ...
                                                        <div class="pagination-group">
                                                            <a href="#" class="p_prev">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="9.414" height="16.828" viewbox="0 0 9.414 16.828">
                                                                    <path data-name="Icon feather-chevron-left" d="M20.5,23l-7-7,7-7" transform="translate(-12.5 -7.586)" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                                                                </svg>
                                                            </a>
                                                            ...
                                                            <a href="#!+1" class="p_next">
                                                                <svg width="10" height="16" viewbox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M1.5 1L8.5 8L1.5 15" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                </svg>
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                            ...
                                                            <div class="rating-range-item d-flex align-items-center four-star">
                                                                <div class="rating-range-item-ratings">
                                                                    <ul class="list-inline">
                                                                        ...
                                                                        <li class="list-inline-item">
                                                                            <svg class="fill-star" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                                                            </svg>
                                                                        </li>
                                                                    </ul>
                                                    ...
                                                    <div class="students-feedback">
                                                        <div class="students-feedback-heading">
                                                            <h5 class="font-title--card">Students Feedback <span>(57,685)</span></h5>
                                                            <div class="right">
                                                                ...
                                                                <div class="feedback-rating-start">
                                                                    ...
                                                                    <div class="text">
                                                                        <h6 class="font-para--md">
                                                                            <a href="students-profile.html.htm">Harry Pinsky</a>
                                                                        </h6>
                                                                        <p>1 hour ago</p>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="cart">
                                <div class="cart__price">
                                    ...
                                    <div class="current-discount">
                                        <p class="font-para--md">{{$course->discount}}% off</p>
                                    </div>
                                </div>
                                <div class="cart__price">
                                    <div class=" w-100" id="">
                                        <div class="d-flex  w-100">
                                            <form id="" method="post" action="{{ route('courses.update', $course->id) }}" class="d-flex w-80 flex-fill" enctype="multipart/form-data">
                                                ...
                                                <input type="submit" value="Save" class="btn btn-primary px-5 mx-1">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cart__includes-info">
                                    ...
                                    <ul>
                                        <li>
                                            <span><img src="{{asset('images/frontimages/icon/dollar.png')}}" alt="dollar"></span>
                                            <p class="font-para--md">Full Lifetime Access</p>
                                        </li>
                                        <li>
                                            <span><img src="{{asset('images/frontimages/icon/clock-2.png')}}" alt="clock"></span>
                                            <p class="font-para--md">30 Days Money Back Guarantee</p>
                                        </li>
                                        <li>
                                            <span><img src="{{asset('images/frontimages/icon/paper-plus.png')}}" alt="paper-plus"></span>
                                            <p class="font-para--md">Free Exercises File</p>
                                        </li>
                                        <li>
                                            <span><img src="{{asset('images/frontimages/icon/airplay.png')}}" alt="airplay"></span>
                                            <p class="font-para--md">Access on Mobile , Tablet and TV</p>
                                        </li>
                                        <li>
                                            <span><img src="{{asset('images/frontimages/icon/clipboard.png')}}" alt="clipboard"></span>
                                            <p class="font-para--md">Certificate of Completion</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="cart__share-content d-none">
...
<script>
    $(document).ready(function () {
        ...
        $("#courseNamepen").click(function(){
            $("#courseNameForm").toggleClass("d-none");
            $("#courseName").toggleClass("d-none");
            $("#courseNamepen").toggleClass("d-none");
        });

        $("#courseNameFormCancel").click(function(){
            $("#courseNameForm").toggleClass("d-none");
            $("#courseName").toggleClass("d-none");
            $("#courseNamepen").toggleClass("d-none");
        });
        // courser instructor
        $("#courseInspen").click(function(){
            $("#courseInsForm").toggleClass("d-none");
            $("#courseIns").toggleClass("d-none");
            $("#courseInspen").toggleClass("d-none");
        });

        $("#courseInsFormCancel").click(function(){
            $("#courseInsForm").toggleClass("d-none");
            $("#courseIns").toggleClass("d-none");
            $("#courseInspen").toggleClass("d-none");
        });
        // courser thumbnail
        $("#courseThumbpen").click(function(){
            $("#courseThumbForm").toggleClass("d-none");
            $("#courseThumb").toggleClass("d-none");
            $("#courseThumbpen").toggleClass("d-none");
        });

        $("#courseThumbFormCancel").click(function(){
            $("#courseThumbForm").toggleClass("d-none");
            $("#courseThumb").toggleClass("d-none");
            $("#courseThumbpen").toggleClass("d-none");
        });
