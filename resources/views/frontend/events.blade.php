...
@section('content')
        ...
        <section class="section event-search mt-3">
            <div class="container">
                        ...
                        <div class="event-search-bar">
                            <form action="#">
                                <div class="form-input-group">
                                    ...
                                    <button class="button button-lg button--primary" type="submit" id="button-addon2">Search</button>
                    ...
                    <div class="col">
                        ...
                        <div class="row event-search-content">
                            <div class="col-md-4 mb-4">
                                @include('frontend.inc.event_showcase')
                            </div>
                        </div>

                        <div class="d-none pagination-group my-4">
                            <a href="#" class="p_prev">
