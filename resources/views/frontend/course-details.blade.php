                    ...
                    <div class="col-lg-8">
                        <div class="course-overview">
                            <div class="video-area d-none">
                                <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/674400734?h=7dbeb59448&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479&amp;title=0&amp;byline=0&amp;portrait=0&amp;sidedock=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="VCourse Video Intro"></iframe></div>
                            </div>
                            <div class="video-area">
                                <div >
                                    <video width="100%" controls>
                                        <source src="{{$course->media_link}}" type="video/mp4">
                                    </video>
                                </div>
                            </div>

                            <div class="only-phone mt-5 d-md-none">
                                ...
                                @if ($course->nextBatch->count()){{-- If next batch is starting soon--}}
                                    <div class="cart__checkout-process">
                                        <p class="time-left text-center d-none"><span>5 hours</span> to remaining this price</p>
                                        ...
                                        @auth
                                            @if ($cart->where('id',$course->id)->count())
                                                <a href="{{route('cart.index')}}" class="button button-sm button--primary w-100">Go to cart and checkout</a>
                                            @else
                                                ...
                                                @else
                                                    @if ($startingSoon)
                                                        <p class="text-center h5">Thanks for enrolling to this Course<br>Class will be start Soon</p>
                                                        {{-- [0]->class_starting_date --}}
                                                    @else
                                                    <a href="{{route('courses.watch',$course->id)}}" class="button button-lg button--primary-outline mt-3 w-100">
                                                        Watch Now
                                                    </a>
                                                    @endif
                                        ...
                                        {{-- guest --}}
                                        @guest
                                            <a class="button button-lg button--primary w-100" href="{{ route('register.perform')}}">Join And Enroll</a>
                                            {{--  --}}
                                        @endguest

                                    </div>
                                @else{{-- If there is no batch for enrollment--}}
                                    ...
                                    @else
                                        <div class="cart__checkout-process">
                                            <a class="button button-lg button--primary w-100">Enrollment will Start Soon.</a>
                                        </div>
                                    @endif
                                @endif
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="course-instructor">
                                                ...
                                                @php
                                                    $userAbout = str_replace( '&', '&amp;',$course->user->about_me );
                                                @endphp
                                                <p class="font-para--md">
                                                    <?= $userAbout ?>
                                                </p>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        ...
                        <div class="courseCard--wrapper">
                            <div class="cart">
                                @role('admin')
                                <div class=" mb-3">
                                    <a href="{{route('courses.edit',$course->id)}}" class="btn btn-primary me-2">Edit</a>
