        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="footer__wrapper">
                    ...
                    <p>
                        Home 234, Phase 2, Road 10,<br/> Sonadanga, Khulna 9100,<br/> Khulna Division,<br/> Bangladesh.
                    </p>
                    <div class="footer__wrapper_social d-none d-lg-block">
                        <ul>
                            <li>
                                <a href="https://www.instagram.com/vcourse.net.bd/" class="" target="_blank">
                            ...
                            <li>
                                <a href="https://www.facebook.com/VCourseBD/" target="_blank">
            ...
            <div class="col-lg-2 col-sm-4 col-6">
                <div class="footer__list">
                    <h6>Support</h6>
                    <ul>
                        <li><a href="{{route('home.contact')}}">Help &amp; Supports </a></li>
                        <li><a href="{{route('home.privacy_policy')}}">Privacy policy</a></li>
                        <li><a href="{{route('home.faq')}}">FAQs</a></li>
                        <li><a href="{{route('home.contact')}}">Contact Us</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-sm-4 col-6 quick-link">
                <div class="footer__list">
                    <h6>Quick Links</h6>
                    <ul>
                        <li><a href="{{route('events.index')}}">Events</a></li>
                        <li><a href="{{route('home.becomeInstructor')}}">Become a Instructor</a></li>
                        <li class="d-none"><a href="#">Partnerships</a></li>
                        <li class="d-none"><a href="#">Get the app</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-12 d-block d-lg-none">
                <div class="footer__wrapper_social d-flex justify-content-center mob-footer-social">
                    <ul>
                        <li>
                            <a href="https://www.facebook.com/VCourseBD/" target="_blank">
                                <svg width="9" height="18" viewbox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="footer__bottom-content">
                <div class="footer__bottom_copyright">
                    <p>© 2022 - Vcourse (A Sister Concern of <a href="https://thevirtualbd.com" target="_blank">The Virtual BD</a>). All rights reserved </p>
                </div>
