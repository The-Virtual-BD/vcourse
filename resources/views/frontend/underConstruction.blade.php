    ...
    <body style="background-color: #ebebf2;" onload="loader()">
                ...
                <div class="row">
                    <div class="comingsoon-header">
                        <a class="logo" href="{{route('home.index')}}">
                            <img src="{{asset('images/vcourse.png')}}" alt="logo" class="img-fluid">
                        </a>
                        <div class="footer__wrapper_social mt-0 d-none">
                            <ul>
                                {{-- <li>
                                    <a href="#">
        ...
        <section class="comingsoon-area">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        <div class="comingsoon-area-start">
                            <h1 class="font-title--lg">Under Maintenance</h1>
            ...
            <div class="comingsoon-area-shape">
                <img src="{{asset('images/frontimages/comingsoon/01.png')}}" alt="Shape" class="img-fluid shape-01">
                <img src="{{asset('images/frontimages/comingsoon/02.png')}}" alt="Shape" class="img-fluid shape-02">
                <img src="{{asset('images/frontimages/comingsoon/03.png')}}" alt="Shape" class="img-fluid shape-03">
                <img src="{{asset('images/frontimages/comingsoon/04.png')}}" alt="Shape" class="img-fluid shape-04">
            </div>
        </section>
        ...
        <script src="src/scss/vendors/plugin/js/jquery.syotimer.min.js"></script>
