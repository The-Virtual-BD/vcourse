...
<html lang="en">
    <head>
        ...
        <title>Email Verification-Eduguard</title>
    ...
    <body onload="loader()">
                                        ...
                                        <li class="submenu active">
                                            ...
                                            <div class="nav-item--subDropdown">
                                                <ul>
                                                    ...
                                                    <li><a href="verify.html.htm" class="active">Verify Email</a></li>
                                                    <li><a href="forget-password.html.htm">Forget Password</a></li>
                                                    <li><a href="reset-password.html.htm">Reset Password</a></li>
                                                </ul>
                                            </div>
                                        </li>
        ...
        <div class="dot-images">
            <img src="dist/images/shape/dots/dots-img-10.png" style="z-index: 1;" alt="shape" class="img-fluid first-dotimage">
