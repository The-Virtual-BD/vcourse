...
@section('content')
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="created-by d-flex align-items-center">
                                <div class="created-by-image me-3">
                                    <img src="{{asset('images/frontimages/courses/profile.png')}}" alt="">
                                </div>
                                <div class="created-by-text">
                                    <p>Created by</p>
                                    <h6><a href="{{url('instructor-profile
                                    ')}}">{{$course->user->name}}</a></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            <div class="course-overview">
                                <div class="course-overview-image">
                                    <img src="{{asset('images/frontimages/courses/thumb.jpg')}}" alt="img">
                                ...
                                <ul class="nav course-overview-nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active font-para--lg" id="pills-courseoverview-tab" data-bs-toggle="pill" data-bs-target="#pills-courseoverview" type="button" role="tab" aria-controls="pills-courseoverview" aria-selected="true">
                                            Overview
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link font-para--lg" id="pills-c-instructor-tab" data-bs-toggle="pill" data-bs-target="#pills-c-instructor" type="button" role="tab" aria-controls="pills-c-instructor" aria-selected="false">
                                            Instructor
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link me-0 font-para--lg" id="pills-course-review-tab" data-bs-toggle="pill" data-bs-target="#pills-review" type="button" role="tab" aria-controls="pills-course-review-tab" aria-selected="false">
                                            Review
                                        </button>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-courseoverview" role="tabpanel" aria-labelledby="pills-courseoverview-tab">
                                        ...
                                        <div class="row course-overview-main mt-4">
                                            ...
                                            <div class="course-overview-main-item">
                                                ...
                                                <p class="bullets-line">
                                                    <svg width="14" height="10" viewbox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1 5L13 5" stroke="#202029" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        <path d="M9 0.999999L13 5L9 9" stroke="#202029" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                            ...
                                            <div class="course-overview-main-item mb-0">
                                                ...
                                                <p class="bullets-line">
                                                    <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M15 4.5L6.75 13.5L3 9.40909" stroke="#00AF91" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                    This Course for Complete Beginner Students who want learn UI/UX.
                                                </p>
                                                <p class="bullets-line">
                                                    ...
                                                    <div class="curriculum-area-top" role="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                                                        <div class="curriculum-area-top-start">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewbox="0 0 20 20" fill="none">
                                                                <path d="M15.8332 7.08337L9.99984 12.9167L4.1665 7.08337" stroke="#42414B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            </svg>
                                                ...
                                                <div class="course-instructor">
                                                    <div class="course-instructor-info">
                                                        <div class="instructor-image">
                                                            <img src="{{asset('images/frontimages/courses/courseinstructor.png')}}" alt="Instructor">
                                                        </div>
            ...
            <section class="section new-course-feature section--bg-offwhite-five">
                                ...
                                <div class="new__courses">
                                    <div class="contentCard contentCard--course contentCard--space">
                                        <div class="contentCard-top">
                                            <a href="course-details.html.htm"><img src="{{asset('images/frontimages/courses/demo-img-01.png')}}" alt="images" class="img-fluid"></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="course-details.html.htm" class="font-title--card">Chicago International Conference on Education</a>
                                            </h5>
                                            <div class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="{{url('instructor-profile
                                                ')}}" class="contentCard-user d-flex align-items-center">
                                                    <img src="{{asset('images/frontimages/courses/7.png')}}" alt="client-image" class="rounded-circle">
                                    ...
                                    <div class="contentCard contentCard--course contentCard--space">
                                        <div class="contentCard-top">
                                            <a href="course-details.html.htm"><img src="{{asset('images/frontimages/courses/demo-img-02.png')}}" alt="images" class="img-fluid"></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="course-details.html.htm" class="font-title--card">Chicago International Conference on Education</a>
                                    ...
                                    <div class="contentCard contentCard--course contentCard--space">
                                        <div class="contentCard-top">
                                            <a href="course-details.html.htm"><img src="{{asset('images/frontimages/courses/demo-img-03.png')}}" alt="images" class="img-fluid"></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="course-details.html.htm" class="font-title--card">Chicago International Conference on Education</a>
                                    ...
                                    <div class="contentCard contentCard--course contentCard--space">
                                        <div class="contentCard-top">
                                            <a href="course-details.html.htm"><img src="{{asset('images/frontimages/courses/demo-img-04.png')}}" alt="images" class="img-fluid"></a>
                                        </div>
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="course-details.html.htm" class="font-title--card">Chicago International Conference on Education</a>
                ...
                <div class="new-course-overlay">
                    <img src="{{asset('images/frontimages/shape/circle5.png')}}" alt="shape" class="img-fluid shape01">
                    <img src="{{asset('images/frontimages/shape/dots/dots-img-15.png')}}" alt="shape" class="img-fluid shape02">
                </div>
            </section>
@endsection
