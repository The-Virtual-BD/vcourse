...
@section('content')
                            ...
                            <form method="post" action="{{ route('login.perform') }}">
                                ...
                                <div class="form-element "><!--success-->
                                    ...
                                    <div class="form-alert-input">
                                        <input type="text" placeholder="Type here" name="username" id="username">
                                    </div>
                                </div>
                                <div class="form-element"><!--active-->
                                    <div class="d-flex justify-content-between">
                                        <label for="confirm-password">Password</label>
                                        <a href="{{route('password.request')}}" class="text-primary fs-6">Forget Password</a>
                                    </div>

                                    <div class="form-alert-input">
                                        <input name="password" type="password" placeholder="Type here..." id="confirm-password">
                                        <div class="form-alert-icon" onclick="showPassword('confirm-password',this);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye-off"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg> </div>
                                    </div>
                                </div>
                                <div class="form-element d-flex align-items-center terms">
                                    <input class="checkbox-primary me-1" type="checkbox" id="agree" name="remember" value="1">
        ...
        <div class="dot-images">
            <img src="{{asset('images/frontimages/shape/dots/dots-img-10.png')}}" alt="shape" style="z-index: 1;" class="img-fluid first-dotimage">
